...
def mytsne(h, y, ax, title):
    ...
    """
    X = h
    perplexity = 10   # Our HW 20; Our fashion 50;MTD HW 10;RANK HW 10
...
# 显示图像
plt.tight_layout()
plt.savefig(r"D:\python project\MVMLC\新方法 - 副本 - 副本\tsne\tsne_{}_{}_{}_knowledge.pdf".format(method,dataset,missing_rate), format='pdf', bbox_inches='tight')
plt.show()
