...
def mytsne(h, y, ax, title):
    ...
    """
    X = h
    perplexity = 5   # Our HW 20; Our fashion 50;MTD HW 10;RANK HW 10,LMVCAT HW 0.5 20;DIMC 0.9 10;DICNET 5
...
# 从 .pkl 文件加载数据
with open(r'D:\python project\MVMLC\tsne_representation_label\feature_{}_{}_{}.pkl'.format(method,dataset,missing_rate), 'rb') as f:
    X1 = pickle.load(f)
with open(r'D:\python project\MVMLC\tsne_representation_label\label_{}_{}_{}.pkl'.format(method,dataset,missing_rate), 'rb') as f:
    Y1 = pickle.load(f)
...
# 显示图像
plt.tight_layout()
plt.savefig(r"D:\python project\MVMLC\新方法 - 副本 - 副本\tsne\tsne_{}_{}_{}.pdf".format(method,dataset,missing_rate), format='pdf', bbox_inches='tight')
plt.show()
